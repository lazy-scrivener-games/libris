...
* Adding `--watch` or `-w` will watch the config file and all files it points to, re-building the PDF whenever they change. Example: `python3 enki.py --watch example/example-config.json`